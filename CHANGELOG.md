...
- [WPCLI] The result of `wp device` commands are now logged in [DecaLog](https://wordpress.org/plugins/decalog/).
...
- [WPCLI] The result of `wp device` commands are now prefixed by the product name.
