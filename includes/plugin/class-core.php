...
use PODeviceDetector\System\Loader;
...
class Core {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_filter( 'plugin_action_links_' . plugin_basename( PODD_PLUGIN_DIR . PODD_SLUG . '.php' ), $plugin_admin, 'add_actions_links', 10, 4 );
	...
	public static function get_base64_logo() {
		...
		$source .= '<g id="device-detector" serif:id="Device Detector" transform="matrix(10.0067,0,0,10.0067,0,0)">';
