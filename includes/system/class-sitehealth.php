	...
	public static function perfopsone_test_objectcache_do() {
		...
		if ( 'db_transient' === $analytics['type'] ) {
			$result = [
				...
				'description' => sprintf( '<p>%s %s</p>', esc_html__( 'Your site uses database transient.', 'device-detector' ), esc_html__( 'You should consider using a dedicated object caching mechanism, like Memcached or Redis, to improve your site\'s speed.', 'device-detector' ) ),
				'actions'     => '',
				'test'        => $key,
			];
			...
			$result = [
				...
				'description' => sprintf( '<p>%s %s</p>', esc_html__( 'Your site uses APCu, but only a few plugins know how to take advantage of it.', 'device-detector' ), esc_html__( 'You should consider using a dedicated object caching mechanism, like Memcached or Redis, to improve your site\'s speed.', 'device-detector' ) ),
				'actions'     => '',
				'test'        => $key,
			];
